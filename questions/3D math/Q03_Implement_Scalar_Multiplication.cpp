...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q03_Implement_Scalar_Multiplication.cpp -o "../../questions_artifacts/3D math/3d_math_q03" && "../../questions_artifacts/3D math/3d_math_q03"
