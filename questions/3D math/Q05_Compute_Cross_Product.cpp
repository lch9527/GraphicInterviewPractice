...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q05_Compute_Cross_Product.cpp -o "../../questions_artifacts/3D math/3d_math_q05" && "../../questions_artifacts/3D math/3d_math_q05"
