...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q07_Normalize_a_Vector_Safely.cpp -o "../../questions_artifacts/3D math/3d_math_q07" && "../../questions_artifacts/3D math/3d_math_q07"
