...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q34_Make_Billboard_Quad_Face_Camera.cpp -o "../../questions_artifacts/3D math/3d_math_q34" && "../../questions_artifacts/3D math/3d_math_q34"
