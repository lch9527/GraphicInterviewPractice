...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q27_Ray-Sphere_Intersection.cpp -o "../../questions_artifacts/3D math/3d_math_q27" && "../../questions_artifacts/3D math/3d_math_q27"
