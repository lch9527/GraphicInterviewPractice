...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q16_Distance_Between_Two_Points.cpp -o "../../questions_artifacts/3D math/3d_math_q16" && "../../questions_artifacts/3D math/3d_math_q16"
