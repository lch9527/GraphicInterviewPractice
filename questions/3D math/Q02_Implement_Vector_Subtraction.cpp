...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q02_Implement_Vector_Subtraction.cpp -o "../../questions_artifacts/3D math/3d_math_q02" && "../../questions_artifacts/3D math/3d_math_q02"
