...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q12_Calculate_Triangle_Normal.cpp -o "../../questions_artifacts/3D math/3d_math_q12" && "../../questions_artifacts/3D math/3d_math_q12"
