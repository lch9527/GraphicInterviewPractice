...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q04_Compute_Dot_Product.cpp -o "../../questions_artifacts/3D math/3d_math_q04" && "../../questions_artifacts/3D math/3d_math_q04"
