...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q32_Clamp.cpp -o "../../questions_artifacts/3D math/3d_math_q32" && "../../questions_artifacts/3D math/3d_math_q32"
