...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q01_Implement_Vector_Addition.cpp -o "../../questions_artifacts/3D math/3d_math_q01" && "../../questions_artifacts/3D math/3d_math_q01"
