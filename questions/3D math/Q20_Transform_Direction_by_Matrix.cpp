...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q20_Transform_Direction_by_Matrix.cpp -o "../../questions_artifacts/3D math/3d_math_q20" && "../../questions_artifacts/3D math/3d_math_q20"
...
Vec3 TransformDirection(const Mat4& m, const Vec3& dir) {
    ...
    Vec4 transformedPoint = Mul(m, Vec4{dir.x, dir.y, dir.z, 0.0f});
