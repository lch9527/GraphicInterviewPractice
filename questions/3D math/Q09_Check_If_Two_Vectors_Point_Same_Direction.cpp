...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q09_Check_If_Two_Vectors_Point_Same_Direction.cpp -o "../../questions_artifacts/3D math/3d_math_q09" && "../../questions_artifacts/3D math/3d_math_q09"
