...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q30_Vector_Lerp.cpp -o "../../questions_artifacts/3D math/3d_math_q30" && "../../questions_artifacts/3D math/3d_math_q30"
