...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q21_Compose_Transform_Matrix.cpp -o "../../questions_artifacts/3D math/3d_math_q21" && "../../questions_artifacts/3D math/3d_math_q21"
