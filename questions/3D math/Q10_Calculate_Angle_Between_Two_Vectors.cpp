...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q10_Calculate_Angle_Between_Two_Vectors.cpp -o "../../questions_artifacts/3D math/3d_math_q10" && "../../questions_artifacts/3D math/3d_math_q10"
