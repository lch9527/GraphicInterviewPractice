...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q17_Build_Translation_Matrix.cpp -o "../../questions_artifacts/3D math/3d_math_q17" && "../../questions_artifacts/3D math/3d_math_q17"
