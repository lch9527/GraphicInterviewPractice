...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q13_Check_If_Triangle_Faces_Camera.cpp -o "../../questions_artifacts/3D math/3d_math_q13" && "../../questions_artifacts/3D math/3d_math_q13"
