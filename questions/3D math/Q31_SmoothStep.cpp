...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q31_SmoothStep.cpp -o "../../questions_artifacts/3D math/3d_math_q31" && "../../questions_artifacts/3D math/3d_math_q31"
