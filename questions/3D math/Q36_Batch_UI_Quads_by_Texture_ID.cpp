...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q36_Batch_UI_Quads_by_Texture_ID.cpp -o "../../questions_artifacts/3D math/3d_math_q36" && "../../questions_artifacts/3D math/3d_math_q36"
