...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q18_Build_Scale_Matrix.cpp -o "../../questions_artifacts/3D math/3d_math_q18" && "../../questions_artifacts/3D math/3d_math_q18"
