...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q28_Ray-AABB_Intersection.cpp -o "../../questions_artifacts/3D math/3d_math_q28" && "../../questions_artifacts/3D math/3d_math_q28"
