...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q15_Project_One_Vector_Onto_Another.cpp -o "../../questions_artifacts/3D math/3d_math_q15" && "../../questions_artifacts/3D math/3d_math_q15"
