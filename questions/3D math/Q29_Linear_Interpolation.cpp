...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q29_Linear_Interpolation.cpp -o "../../questions_artifacts/3D math/3d_math_q29" && "../../questions_artifacts/3D math/3d_math_q29"
