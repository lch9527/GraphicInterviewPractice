...
//   mkdir -p "../../questions_artifacts/3D math" && g++ -std=c++17 -I../../include Q11_Check_If_Target_Is_Inside_Field_of_View.cpp -o "../../questions_artifacts/3D math/3d_math_q11" && "../../questions_artifacts/3D math/3d_math_q11"
